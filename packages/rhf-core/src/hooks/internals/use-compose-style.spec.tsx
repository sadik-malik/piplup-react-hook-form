...
import { useUnstableComposeStyle as useComposeStyle, type UseComposeStyleProps } from './use-compose-style'
...
describe('useComposeStyle', () => {
  it('applies style object directly', () => {
    cy.mount(<Comp modifierState={{ disabled: false, error: false }} style={{ color: 'red' }} />)
